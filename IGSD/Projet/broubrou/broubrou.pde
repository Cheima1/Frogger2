...
void draw() {
  ...
  // ___________________________ AVENTURIER ______________________________________________
  if (inLab) {
  ...
  // _______________ PYRAMID ___________________
    ...
    // _______________ FIN PYRAMID ___________________

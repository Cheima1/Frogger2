      ...
      for (int i=0; i<LAB_SIZE-n*2; i++) {
        if (labyrinthe[n][j][i]=='#') {
          ...
          if (j==0 || labyrinthe[n][j-1][i]==' ') {
            ...
            for (int k=0; k<MUR; k++)
              for (int l=-MUR; l<MUR; l++) {
                ...
                laby.vertex(i*wallW-wallW/2+(k+0)*wallW/MUR, j*wallH-wallH/2, (l+0)*50/MUR+n*100, k/(float)MUR*texture0.width, (0.5+l/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+1)*wallW/MUR, j*wallH-wallH/2, (l+0)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+l/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+1)*wallW/MUR, j*wallH-wallH/2, (l+1)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+0)*wallW/MUR, j*wallH-wallH/2, (l+1)*50/MUR+n*100, k/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
              }
          }
          ...
          if (j==LAB_SIZE-1 || labyrinthe[n][j+1][i]==' ') {
            ...
            for (int k=0; k<MUR; k++)
              for (int l=-MUR; l<MUR; l++) {
                laby.vertex(i*wallW-wallW/2+(k+0)*wallW/MUR, j*wallH+wallH/2, (l+1)*50/MUR+n*100, (k+0)/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+1)*wallW/MUR, j*wallH+wallH/2, (l+1)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+1)*wallW/MUR, j*wallH+wallH/2, (l+0)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+(l+0)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2+(k+0)*wallW/MUR, j*wallH+wallH/2, (l+0)*50/MUR+n*100, (k+0)/(float)MUR*texture0.width, (0.5+(l+0)/2.0/MUR)*texture0.height);
              }
          }
          // 2
          if (i==0 || labyrinthe[n][j][i-1]==' ') {
            ...
            for (int k=0; k<MUR; k++)
              for (int l=-MUR; l<MUR; l++) {
                laby.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/MUR, (l+1)*50/MUR+n*100, (k+0)/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/MUR, (l+1)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+(l+1)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/MUR, (l+0)*50/MUR+n*100, (k+1)/(float)MUR*texture0.width, (0.5+(l+0)/2.0/MUR)*texture0.height);
                laby.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/MUR, (l+0)*50/MUR+n*100, (k+0)/(float)MUR*texture0.width, (0.5+(l+0)/2.0/MUR)*texture0.height);
              }
          }
          // 3
          ...
          laby.vertex(i*wallW-wallW/2, j*wallH-wallH/2, -50+n*100, 0, 0);
          laby.vertex(i*wallW+wallW/2, j*wallH-wallH/2, -50+n*100, 0, 1);
          laby.vertex(i*wallW+wallW/2, j*wallH+wallH/2, -50+n*100, 1, 1);
          laby.vertex(i*wallW-wallW/2, j*wallH+wallH/2, -50+n*100, 1, 0);
          
          ceil.fill(32); // top of walls
          ceil.vertex(i*wallW-wallW/2, j*wallH-wallH/2, 50+n*100);
          ceil.vertex(i*wallW+wallW/2, j*wallH-wallH/2, 50+n*100);
          ceil.vertex(i*wallW+wallW/2, j*wallH+wallH/2, 50+n*100);
          ceil.vertex(i*wallW-wallW/2, j*wallH+wallH/2, 50+n*100);
        }

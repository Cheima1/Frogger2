...
void momie() {
  /*PShape momiie = createShape(GROUP);
  arm = createShape();
  body = createShape();
  head = createShape();
  ...
  momiie.addChild(head);
  momiie.addChild(arm);
  momiie.addChild(body);*/
...
void draw() {
  ...
  //FIN MOMIE
  popMatrix();
  // ______________ FIN MOMIE _______________________
  pushMatrix();
  translate(-500, -500, -765);
  rotateX(PI);
  rotateZ(PI/2);
  //rotateY(-PI/2);
  scale(20);
